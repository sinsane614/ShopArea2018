...
-->
  <div id="main">
    ...
    <h1><center>ร้านค้าที่มี Rating เฉลี่ยมากที่สุด</center></h1><hr>
    <div class="container justify-content-md-center shadow-none p-3 mb-5 rounded" style="border:1px solid #cecece; width:80%" >
        ...
        <table class="table table-hover" style="width:100%">
                ...
                <tr>
                    <th></th>
                    <th><h2><center>ร้านค้า</center></h2></th>
                    <th><h2><center>Rating</center></h2></th>
                </tr>
                </thead>
                <tbody>
                <?php 
                $SQL = "SELECT user.Shopname,AVG(reviewproduct.Rating) AS Rating FROM reviewproduct JOIN checkout ON reviewproduct.OrderID = checkout.OrderID JOIN ordershop ON checkout.OrderID = ordershop.OrderID JOIN user ON ordershop.SellerID = user.UserID GROUP BY user.Shopname ORDER BY Rating DESC";
