          ...
          <div class="container">
            ...
            <div class="tab-content">
              <div id="profile" class="container tab-pane active"><br>
                ...
                <form class="needs-validation" name = "editprofile" method="post" action="editprofile.php" onsubmit ="return CheckForm()" onkeydown="return event.key != 'Enter';" novalidate>
                  <div class="row">
                    <div class="col-md-6 mb-3">
                      <label for="firstName">First name<span class="text-muted"> (ชื่อจริง)</span></label>
                      <input type="text" class="form-control" id="firstName" name="FirstName" placeholder="" value="<?php echo $objResult["Fname"];?>" disabled>
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="text" class="form-control" id="lastName" name="Lastname" placeholder="" value="<?php echo $objResult["Lname"];?>" disabled>
                      <div class="invalid-feedback">
                  ...
                  <div class="mb-3">
                    ...
                    <div class="input-group">
                      ...
                      <input type="password" class="form-control" id="password" name="Pass" placeholder="password" value="<?php echo $objResult["Pass"];?>" disabled>
                      <div class="invalid-feedback" style="width: 100%;">
                        Your username is required.
                      </div>
                    </div>
                  ...
                  <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="email" name="Email" placeholder="you@example.com" value="<?php echo $objResult["Email"];?>" disabled>
                    <div class="invalid-feedback">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="Address" id="address" placeholder="1234 Main St" value="<?php echo $row_address["Address"];?>" disabled>
                    <div class="invalid-feedback">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="date" class="form-control" name="DOB" id="exampleInputDOB1" placeholder="Date of Birth" value="<?php echo $objResult["DOB"];?>" disabled>
                    <div class="invalid-feedback">
                  ...
                  <div class="row">
                    <div class="col-md-4 mb-3">
                      ...
                      <input type="text" class="form-control" id="tel" name="Tel" placeholder="Tel" value="<?php echo $objResult["Tel"];?>" disabled>
                      <div class="invalid-feedback">
              ...
              <div id="seller" class="container tab-pane fade"><br>
                ...
                <form class="needs-validation" name = "editseller" method="post" action="editprofile.php" onsubmit ="return CheckForm()" onkeydown="return event.key != 'Enter';" novalidate>

                  <div class="mb-3">
                    <label for="IdCard">IDCard&nbsp;*<span class="text-muted"> (รหัสบัตรประชาชน 13 หลัก)</span></label>
                    <input type="number" class="form-control" name="IdCard" id="IdCard" placeholder="1234567890123" value="<?php echo $objResult["IdCard"];?>" disabled>
                    <div class="invalid-feedback">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="Banking" id="Banking" placeholder="xxxxxxxxxx" value="<?php echo $objResult["Banking"];?>" disabled>
                    <div class="invalid-feedback">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="Shopname" id="Shopname" placeholder="everything shop" value="<?php echo $objResult["Shopname"];?>" disabled>
                  </div>

                  <div class="mb-3">
                    <label for="Shopdetail">Shopdetail<span class="text-muted"> (รายละเอียดสินค้า)</span></label>
                    <input type="text" class="form-control" name="Shopdetail" id="Shopdetail" placeholder="รายละเอียดสินค้า" value="<?php echo $objResult["Shopdetail"];?>" disabled>
                  </div>
