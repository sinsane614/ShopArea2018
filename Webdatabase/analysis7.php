...
-->
  <div id="main">
    ...
    <h1><center>ออเดอร์ที่มีราคาสูงที่สุดในรอบวัน</center></h1><hr>
    <div class="container justify-content-md-center shadow-none p-3 mb-5 rounded" style="border:1px solid #cecece; width:80%" >
        ...
        <table class="table table-hover" style="width:100%">
                ...
                <tr>
                    <th></th>
                    <th><h2><center>OrderID</center></h2></th>
                    <th><h2><center>Price</center></h2></th>
                </tr>
                </thead>
                <tbody>
                <?php 
                $SQL = "SELECT  checkout.OrderID,checkout.totalprice FROM checkout WHERE checkout.OrderDate IN ('$date') ORDER BY checkout.totalprice DESC LIMIT 5";
                ...
                while($row1 = $query->fetch_assoc()){
                    ...
                    <tr>
                        <td></td>
                        <td><h3><center><?php echo $row1['OrderID'] ?></center></h3></td>
                        <td><h3><center><?php echo $row1['totalprice'] ?></center></h3></td>
                    </tr>
...
function closeNav() {
  document.getElementById("mySidepanel").style.width = "0";
    ...
    function changedate(){
        ...
        window.location="analysis7.php?date="+date;
        console.log(date);
    }
  </script>
</body>
