...
-->
  <div id="main">
    ...
    <h1><center>ประเภทสินค้าที่มียอดขายมากที่สุดในรอบเดือน</center></h1><hr>
...
function closeNav() {
  document.getElementById("mySidepanel").style.width = "0";
    ...
    function changemonth(){
        ...
        window.location="analysis3.php?month="+month;
        console.log(month);
    }
  </script>
</body>
