...
-->
  <div id="main">
    ...
    <h1><center>โปรโมชั่นที่มีผู้ใช้มากที่สุดในรอบวัน</center></h1><hr>
    <div class="container justify-content-md-center shadow-none p-3 mb-5 rounded" style="border:1px solid #cecece; width:80%" >
        <div class="col-sm-3">
        <input class="form-control" type="date" id="date" name="bdaydate" value="<?php echo $date?>" onchange='changedate();'><br>
        </div>
        ...
        <table class="table table-hover" style="width:100%">
                ...
                <tr>
                    <th></th>
                    <th><h2><center>Promotion</center></h2></th>
                    <th><h2><center>Count</center></h2></th>
                </tr>
                </thead>
                <tbody>
                <?php 
                $SQL = "SELECT  checkout.PromoCode,COUNT(checkout.PromoCode) AS Frequency  FROM checkout WHERE checkout.OrderDate IN ('$date') AND checkout.PromoCode IS NOT NULL GROUP BY checkout.PromoCode ORDER BY Frequency DESC LIMIT 5";
                ...
                while($row1 = $query->fetch_assoc()){
                    ...
                    <tr>
                        <td></td>
                        <td><h3><center><?php echo $row1['PromoCode'] ?></center></h3></td>
...
function closeNav() {
  document.getElementById("mySidepanel").style.width = "0";
    ...
    function changedate(){
        ...
        window.location="analysis6.php?date="+date;
        console.log(date);
    }
  </script>
</body>
