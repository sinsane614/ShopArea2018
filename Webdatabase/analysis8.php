...
-->
  <div id="main">
    ...
    <h1><center>ยอดรวมการซื้อ มากที่สุดในรอบเดือนของ user</center></h1><hr>
    <div class="container justify-content-md-center shadow-none p-3 mb-5 rounded" style="border:1px solid #cecece; width:80%" >
        ...
        <table class="table table-hover" style="width:100%">
                ...
                <tr>
                    <th></th>
                    <th><h2><center>User</center></h2></th>
                    <th><h2><center>Total Price</center></h2></th>
                </tr>
                </thead>
                <tbody>
                <?php 
                $SQL = "SELECT  user.Fname AS user , SUM(checkout.totalprice) AS Frequency FROM checkout JOIN user ON (checkout.UserID = user.UserID ) WHERE checkout.OrderDate BETWEEN '".$month."-1' AND '".$month."-31'  GROUP BY user.UserID ORDER BY Frequency DESC";
                ...
                while($row1 = $query->fetch_assoc()){
                    ...
                    <tr>
                        <td></td>
                        <td><h3><center><?php echo $row1['user'] ?></center></h3></td>
...
function closeNav() {
  document.getElementById("mySidepanel").style.width = "0";
    ...
    function changemonth(){
        ...
        window.location="analysis8.php?month="+month;
        console.log(month);
    }
  </script>
</body>
