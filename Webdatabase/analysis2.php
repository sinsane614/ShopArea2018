...
-->
  <div id="main">
    ...
    <h1><center>ร้านค้าที่ขายได้มากที่สุดในรอบวัน</center></h1><hr>
    <div class="container justify-content-md-center shadow-none p-3 mb-5 rounded" style="border:1px solid #cecece; width:80%" >
        <div class="col-sm-3">
        <input class="form-control" type="date" id="month" name="bdaymonth" value="<?php echo $month?>" onchange='changemonth();'><br>
        </div>
        ...
        <table class="table table-hover" style="width:100%">
                ...
                <tr>
                    <th></th>
                    <th><h2><center>Shopname</center></h2></th>
                    <th><h2><center>Frequency(Order)</center></h2></th>
                </tr>
                </thead>
                <tbody>
                <?php 
                $SQL = "SELECT user.Shopname,COUNT(ordershop.SellerID) AS Frequency FROM checkout JOIN ordershop ON (checkout.OrderID = ordershop.OrderID )JOIN user ON user.UserID = ordershop.SellerID WHERE checkout.OrderDate BETWEEN '".$month."' AND '".$month."' GROUP BY user.Shopname ORDER BY Frequency DESC;" ;
...
function closeNav() {
  document.getElementById("mySidepanel").style.width = "0";
    ...
    function changemonth(){
        ...
        window.location="analysis2.php?month="+month;
    }
  </script>
</body>
</html>
