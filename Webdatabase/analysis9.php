...
-->
  <div id="main">
    ...
    <h1><center>โปรโมชั่นสินค้าลดราคา</center></h1><hr>
    <div class="container justify-content-md-center shadow-none p-3 mb-5 rounded" style="border:1px solid #cecece; width:80%" >
        ...
        <table class="table table-hover" style="width:100%">
                ...
                <tr>
                    ...
                    <th><h2><center>Discount persent</center></h2></th>
                </tr>
                </thead>
                <tbody>
                <?php 
                $SQL = "SELECT  stock.ProductName ,stock.DiscountPrice AS Discountpricepresent  FROM stock WHERE stock.DiscountType LIKE '1' ORDER BY stock.DiscountPrice DESC";
                ...
                while($row1 = $query->fetch_assoc()){
                    ...
                    <tr>
                        ...
                        <td><h3><center><?php echo $row1['Discountpricepresent'] ?></center></h3></td>
                    </tr>
