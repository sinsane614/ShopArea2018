...
-->
  <div id="main">
    ...
    <h1><center>User ที่มีจำนวนรอบการซื้อของที่มากที่สุดประจำเดือน</center></h1><hr>
    <div class="container justify-content-md-center shadow-none p-3 mb-5 rounded" style="border:1px solid #cecece; width:80%" >
        ...
        <table class="table table-hover" style="width:100%">
                ...
                <tr>
                    ...
                    <th><h2><center>Frequency</center></h2></th>
                </tr>
                </thead>
                <tbody>
                <?php 
                $SQL = "SELECT  user.Fname AS user , COUNT(checkout.UserID) AS Frequency 
                FROM checkout JOIN user ON (checkout.UserID = user.UserID ) 
                WHERE checkout.OrderDate BETWEEN '".$month."-1' AND '".$month."-31'
                GROUP BY user.UserID ORDER BY Frequency DESC" ;
...
function closeNav() {
  document.getElementById("mySidepanel").style.width = "0";
    ...
    function changemonth(){
        ...
        window.location="analysis1.php?month="+month;
        console.log(month);
    }
  </script>
</body>
