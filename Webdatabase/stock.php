...
<th scope='col'>Price/Unit</th>
    ...
    <?php $SQLstock= "SELECT * from stock WHERE SellerID ='".$_SESSION['UserID']."'";
        ...
        <td><input disabled type='text' class='form-control' name='productname' placeholder='ProductName' value=".$objstock['ProductName']."><br> </td>
        <td><textarea class='form-control' name='productdetail' disabled>".$objstock['ProductDetail']."</textarea></td>
...
echo"</td>
        <td id='price' name='price'><input type='text' class='form-control' name='price' placeholder='Price' disabled value=".$objstock['Price']."><br> </td>    
           </tr>
        
        ";
    }?>
    </table>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
    
    <form action="stockedit.php">
    &emsp;&emsp;<input type='submit' class="btn btn-info" name="1" value="Edit">
    <a href="home.php">&emsp;&emsp;&emsp;<div class="btn btn-warning">Cancle </div></a>
    </form>
