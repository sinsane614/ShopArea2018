...
-->
  <div id="main">
    ...
    <h1><center>ประเภทปัญหาที่พบมากสุดในรอบเดือน</center></h1><hr>
    <div class="container justify-content-md-center shadow-none p-3 mb-5 rounded" style="border:1px solid #cecece; width:80%" >
        ...
        <table class="table table-hover" style="width:100%">
                ...
                <tr>
                    <th></th>
                    <th><h2><center>Problem Type</center></h2></th>
                    <th><h2><center>Count Of Problem</center></h2></th>
                </tr>
                </thead>
                <tbody>
                <?php 
                $SQL = "SELECT ReportCategory.ReportCategory,COUNT(report.ReportCategoryID)AS Frequency
                FROM report JOIN ReportCategory ON report.ReportCategoryID = ReportCategory.ReportCategoryID 
                WHERE ReportDate BETWEEN '".$month."-1' AND '".$month."-31' 
                GROUP BY reportcategory.ReportCategoryID ORDER BY Frequency DESC" ;
                ...
                while($row1 = $query->fetch_assoc()){
                    ...
                    <tr>
                        <td></td>
                        <td><h3><center><?php echo $row1['ReportCategory'] ?></center></h3></td>
...
function closeNav() {
  document.getElementById("mySidepanel").style.width = "0";
    ...
    function changemonth(){
        ...
        window.location="analysis5.php?month="+month;
        console.log(month);
    }
  </script>
</body>
